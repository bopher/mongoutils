...
func (me *mDoc) Add(k string, v interface{}) MongoDoc {
...
func (me *mDoc) Array(k string, v ...interface{}) MongoDoc {
	return me.Add(k, v)
}
...
func (me *mDoc) Nested(root string, k string, v interface{}) MongoDoc {
...
func (me *mDoc) NestedArray(root string, k string, v ...interface{}) MongoDoc {
	return me.Add(root, primitive.M{k: v})
}
